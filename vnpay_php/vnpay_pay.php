...
<head>
    ...
    <link rel="stylesheet" href="assets/thanhtoan.css">
    ...
    <div class="container">
        ...
        <div class="table-responsive">
            ...
            <form action="vnpay_create_payment.php" id="frmCreateOrder" method="post">
                ...
                <label for="amount">Số tiền</label>
                <input class="option-input" data-val="true" data-val-number="The field Amount must be a number." data-val-required="The Amount field is required." id="amount" name="amount" type="number" value="99000" />
